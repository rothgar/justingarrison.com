...
Here are some of my exeriences and observations about the role change and what it might mean for you if you're looking to do a similar switch.

I was a long time engineer in various roles.
I was a sysadmin for a while, moved to Sr. Systems Engineer, and then my title was Sr. Software Engineer - Lead.

Titles have lots of different meanings depending on where you work and what your team is tasked with.
...
This also made me responsible for a lot of infrastructure that I was on call bi-monthly for.

After 7 years of being responsible for building and maintaining production systems I switched to the developer advocate role for a lot of reasons.
One of those reasons was a lot of the parts of my job that I enjoyed (e.g. teaching people, guiding product) were things that appeared to be responsibilities for a developer advocate.

I had previously been doing [][public speaking] in my free time because it was a chance for me to reach a broader audience and learn a lot.
I learn a lot more when I teach something than when I do something.
...
However, during all of my interviews I made it very clear that I would not be able to travel much for at least the first year due to having a 1 year old baby at the time.
...
The really refreshing thing is I don't have to write code to implement a feature or write code I'll have to support for years in production.
...
For me I get to enjoy writing code a lot more when it has a more finite purpose and won't wake me, or anyone else, up at night.

## I get to learn new things all the time

You know how you have a backlog as an engineer to learn a new tool, framework, service, library, etc.?
And your week is so full of meetings that you're lucky if you get 4 hours a week to learn the new thing.
...
I try to find the sharp edges in our products to make it better for the next user.
...
It's so refreshing to have time to be able to spend time to understand who the customer is, but also to immediately bring customer feedback to the product team on how it can be better.
...
## I have more influence on product than I expected

I've heard devrel is different at lots of companies and so far I'm happy with how it is treated at AWS.

I'm in product design conversations, I've reviewd [][PRFAQs], I've written product feedback documents, and even random ideas for things I think would be useful.
Even when I'm wrong (which has been frequent) everyone I've talked to has been helpful in showing me where my assumptions were innacurate or my gaps in information were leading me down a different train of thought.
...
Even if implementation still take the same amount of time I now get more regular feedback loops and it's my job to help improve the products so I feel more invested.
...
* COVID-19
* I'm new and don't have established relationships
...
I easily averaged 4 meetings a day and that was with a day dedicated to no scheduled meetings.

Some of that is cultural differences at AWS and some of that is freedom and responsibility to work on what I think is the most important.
...
I never thought I would learn so much about how people use social media, articles, and blogs to gain insights into what customers want and are doing.

It's actually really interesting to see conversations sprout from tweets from individuals, blog post from small startups, or random deep dives into a new announcement.
...
I know this isn't the case everywhere, but not just devrel people are paying attention.
Project managers, engineers, and maybe even management show up in threads I would have never seen from Disney.

As a matter of fact Disney actively discouraged engaging with anyone online about work related topics.
For a long time I was terrified to post personal things online.

Disney has a much different relationship with customers than AWS, but sometimes they felt closed minded to what real people were saying.

## I write a lot

I always expected I would write a lot, but I didn't expect that I would spend more time on internal documents than external.
...
In 6 years as an engineer I was able to open source 1 project and had 1 public PR related to work.
...
I'm writing more code than ever but that doesn't mean I understand the constraints of building and operating real systems.
...
I wish there was some way for me to take on responsibilities in real life productions systems for a time to keep the problems fresh in my mind.
...
I think travel and speaking would help but for at least the next year I need to find a better solution.
...
There are great people putting lots of thought into devrel and I've learned a lot from people like [Mary Thengvall](https://twitter.com/mary_grace), [Swarna](https://twitter.com/skpodila), and [Ashley Willis](https://twitter.com/ashleymcnamara).

I never used to put thought into proving the value of engineering, but maybe I have doubts about the value of devrel to the organization.
